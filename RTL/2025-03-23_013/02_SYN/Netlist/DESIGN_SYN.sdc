...
# Created by write_sdc on Tue Mar 25 17:15:59 2025
...
{i_data[2]}] [get_ports {i_data[1]}] [get_ports {i_data[0]}]]  -to [list [get_ports {o_encoded[2]}] [get_ports {o_encoded[1]}] [get_ports    \
{o_encoded[0]}] [get_ports o_valid]]
